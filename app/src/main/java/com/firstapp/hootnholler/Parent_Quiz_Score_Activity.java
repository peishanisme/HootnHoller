...
public class Parent_Quiz_Score_Activity extends AppCompatActivity {
                                                    ...
                                                    CtgRef.child(quizModel.getCategoryKey()).addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                            if (snapshot.exists()) {
                                                                ...
                                                                CtgRef.child(quizModel.getCategoryKey()).child("Sets")
                                                                        .child(quizModel.getSetKey())
                                                                        .child("setName")
                                                                    ...
                                                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                        ...
                                                                        CtgRef.child(quizModel.getCategoryKey()).child("Sets").child(quizModel.getSetKey())
                                                                                ...
                                                                                .addValueEventListener(new ValueEventListener() {
                                                                                    ...
                                                                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                                        //check quiz status
                                                                                        //if completed, total number of quiz, completed quiz will increase
                                                                                        if (snapshot.exists()) {
                                                                                            ...
                                                                                            if (status.equals("Completed")) {
                                                                                                ...
                                                                                                CtgRef.child(quizModel.getCategoryKey()).child("Sets").child(quizModel.getSetKey())
                                                                                                        .child("Answers")
                                                                                                        .child(StudentUid)
                                                                                                        .child("percentage").addValueEventListener(new ValueEventListener() {
                                                                                                            @Override
                                                                                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                                                                // set quiz card view by getting the quiz score
    ...
    public int checkQuizStatus(Quiz quiz, boolean isSubmit) {
        //get dueDate of a certain quiz from database
        Date dueDate = new Date(quiz.getDueDate());
        Date currentDate = new Date();

        //check completed and incomplete quiz based on due date and current date
        // If due
