...
public class Announcement_RecyclerViewAdapter extends RecyclerView.Adapter<Announcement_RecyclerViewAdapter.Viewholder>{
    Context context;
    java.util.ArrayList<Announcement_ArrayAdapter> arrayList = new ArrayList<>();
    ...
    @NonNull
    @Override
    public Announcement_RecyclerViewAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Announcement_RecyclerViewAdapter.Viewholder holder, int position) {
